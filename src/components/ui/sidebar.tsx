...
type SidebarContextProps = {
  ...
  open: boolean;
  showInsetExpanded: boolean;
  showInsetCollapsed: boolean;
...
function Sidebar({
  ...
  return (
    <div
      className="group peer text-sidebar-foreground hidden md:block bg-sidebar border-b border-sidebar-border"
      data-state={state}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-footer relative flex w-full flex-1 flex-col",
